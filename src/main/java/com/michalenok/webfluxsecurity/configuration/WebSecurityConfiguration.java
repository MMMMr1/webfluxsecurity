package com.michalenok.webfluxsecurity.configuration;

import com.michalenok.webfluxsecurity.security.AuthenticationManager;
import com.michalenok.webfluxsecurity.security.BearerTokenServerAuthenticationConverter;
import com.michalenok.webfluxsecurity.security.JwtHandler;
...
public class WebSecurityConfiguration {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, AuthenticationManager authenticationManager){
        return http
                ...
                .and()
                .exceptionHandling()
                .authenticationEntryPoint((sxe, ex) -> {
    ...
    private AuthenticationWebFilter bearerAuthenticationFilter(AuthenticationManager authenticationManager){
        ...
        authenticationWebFilter.setServerAuthenticationConverter(new
